package jl11.vector.impl;

import java.io.Serializable;

public class LinkedVector implements jl11.vector.Vector, Cloneable, Serializable{
    ...
    public double getElement(int index) {
        if (index < 0 || index > size-1){
            throw new jl11.vector.exceptions.VectorIndexOutOfBoundsException();
        }
    ...
    public void fillFromVector(jl11.vector.Vector newVector){
    ...
    public void sum(jl11.vector.Vector newVector) throws jl11.vector.exceptions.IncompatibleVectorSizesException {


        if (size != newVector.getSize()){
            throw new jl11.vector.exceptions.IncompatibleVectorSizesException();
        }
    ...
    public void sort(boolean incr){
        ...
        jl11.vector.Vectors.sort(this, incr);
    }
    ...
    public boolean equals(Object obj){
        if (obj instanceof jl11.vector.Vector){
            if (((jl11.vector.Vector) obj).getSize() != size){
                return false;
            }
            Nod currentElement = head;
