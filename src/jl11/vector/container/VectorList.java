...
public class VectorList<T extends jl11.vector.Vector> extends jl11.vector.container.VectorCollection<T> implements List<T> {

    public VectorList(jl11.vector.Vector[] arr) {
        super(arr);
    }
    ...
    public boolean addAll(int index, Collection c) throws ClassCastException,
        ...
        for (int i = 0; i < c.size(); i++) {
            if (!(newVectorArray[i] instanceof jl11.vector.Vector) && newVectorArray[i] != null) {
        ...
        for (int i = 0; i < newVectorArray.length; i++){
            arr[i + tempArr.length] = (jl11.vector.Vector)newVectorArray[i];
        }
        return true;
    ...
    public T set(int index, T element) throws IndexOutOfBoundsException, ClassCastException,
        ...
        if (!(element instanceof jl11.vector.Vector)){
            throw new ClassCastException();
        }
        Object prevElement = arr[index];
        arr[index] = (jl11.vector.Vector)element;
    ...
    public void add(int index, T element) throws ClassCastException, NullPointerException,
        ...
        if (element instanceof jl11.vector.Vector) {
            ...
            int l = arr.length;
            jl11.vector.Vector[] tempArray = new jl11.vector.Vector[l + 1];
            if (index == l){
                System.arraycopy(arr, 0, tempArray, 0, l);
                tempArray[index] = (jl11.vector.Vector)element;
            } else {
    ...
    public List subList(int fromIndex, int toIndex) throws IndexOutOfBoundsException{
        ...
        jl11.vector.Vector[] newVectorArr = new jl11.vector.Vector[toIndex-fromIndex];
        int newArrIndex = 0;
