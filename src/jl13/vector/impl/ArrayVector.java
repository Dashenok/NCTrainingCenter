...
public class ArrayVector implements jl13.vector.Vector, Cloneable, Serializable {
    protected int size;
    protected double[] mass;
    public ArrayVector(int size) throws jl13.vector.exceptions.VectorIndexOutOfBoundsException {
        if (size < 0) {
            throw new jl13.vector.exceptions.VectorIndexOutOfBoundsException();
        }
        this.size = size;
    ...
    public void fillFromVector(jl13.vector.Vector newVector){
    ...
    public boolean equal(jl13.vector.Vector newVector){
    ...
    public void sum(jl13.vector.Vector newVector) throws jl13.vector.exceptions.IncompatibleVectorSizesException {


        if (size != newVector.getSize()){
            throw new jl13.vector.exceptions.IncompatibleVectorSizesException();
        }
    ...
    public void sort(boolean incr){
        jl13.vector.Vectors.sort(this, incr);
    }
    ...
    public boolean equals(Object obj){
        if (obj instanceof jl13.vector.Vector){
            if (((jl13.vector.Vector) obj).getSize() != size){
                return false;
            }
            for (int i = 0; i < size; i++) {
                return ((jl13.vector.Vector) obj).getElement(i) == getElement(i);
            }
        }
        return  false;
    }
    ...
    public Object clone() throws CloneNotSupportedException{
        ...
        ((jl13.vector.Vector) arrayVector).fillFromMass(mass);
        return arrayVector;
    }
}